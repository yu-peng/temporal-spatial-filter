...
public class SingleSourceSingleDestSolver implements Callable<JSONObject> {
	...
	public SingleSourceSingleDestSolver(double _originLat, double _originLon, double _poiLat, double _poiLon, double _destLat, double _destLon, 
