...
public class SingleSourceSingleDestSingleWptSolver implements Callable<JSONObject> {
	...
	public SingleSourceSingleDestSingleWptSolver(double _originLat, double _originLon, double _wptLat, double _wptLon, double _poiLat, double _poiLon, double _destLat, double _destLon, 
